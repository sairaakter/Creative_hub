...
import futy from "../style/Footer.module.css";

export default function Footer() {
  return (
    <section className={futy.footer}>
      <footer className="">
        <div className="container ban_container">
          <div className={`row ${futy.f_top}`}>
            <div className="col-lg-12 p-0">
              <div className={futy.fot_nav}>
                <div className={futy.fot_logo}>
                  <h5>
                    Creative Hub <br /> IT Agency
                  </h5>
                </div>
                <div className={futy.fotnav_cont}>
                  <div className={futy.f_folow}>
                    <p>Follow us:</p>
                  </div>
                  <div className={futy.folo_logos}>
                    <Link to="#">
                      <svg
                        width="24"
                        height="24"
          ...
          <div className={`row ${futy.f_bottom}`}>
            <div className="col-lg-12 p-0">
              <div className={futy.fot_copyright}>
                <div>
                  <p>
                    <Link to="#">
                ...
                <div className={futy.fot_subcopy}>
                  <p>
